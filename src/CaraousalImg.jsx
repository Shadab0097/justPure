    ...
    <div>
      ...
      <div className='  overflow-x-hidden relative  '>
        ...
        <div className='  absolute  flex justify-between mt-48 w-[1020px] ml-0 md:ml-80 md:w-[600px]'>
          <button className='hidden md:hidden lg:inline-block  pr-4 text-black' onClick={handleLeft}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15.75 3 12m0 0 3.75-3.75M3 12h18" />
            </svg>

          </button>
          <button className=' hidden md:hidden lg:inline-block pr-4  text-black ' onClick={handleRight}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14">
        ...
        <div id='title' className='flex overflow-x-scroll no-scrollbar scroll-smooth'>
          ...
          <div className="flex ">
            ...
            {images.map((image, index) => {
              ...
              return <img src={image} key={index} alt="" className=' h-[382] mt-6 ml-4 mr-4 mb-10' />
