  ...
  return (
    ...
    <section className="flex flex-col md:flex-row">
      ...
      <div className="relative w-full md:w-1/2">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center w-4/5 md:w-auto">
      ...
      <div className="relative w-full md:w-1/2">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center w-4/5 md:w-auto">
          <h1 className="text-xl md:text-xl lg:text-2xl font-bold mb-4">
            <span className="">HOW MUCH DO YOU</span>
            <span className="">REALLY KNOW ABOUT THE WATER</span>
    ...
    <div className="hidden md:flex justify-evenly -mt-11 bg-[#e6e5e7] z-20 py-3 relative">
     <button className="px-7 py-4 text-gray-700 duration-100 border-2 border-black rounded-full hover:border-indigo-600 active:shadow-lg">
          Return & Refund
         </button>
         <button className="px-7 py-4 text-gray-700 duration-100 border-2 border-black rounded-full hover:border-indigo-600 active:shadow-lg">
