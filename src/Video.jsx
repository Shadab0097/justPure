...
const Video = () => {
    return (
        <section className=" pb-4  bg-[#e6e5e7] ">
            <div className="max-w-screen-xl mx-auto text-gray-600  overflow-hidden md:flex md:px-8">
                <div className=''>
                ...
                <div className='absolute sm:pl-[600px] ml-14 -mt-56 text-2xl sm:mt-44 sm:ml-40'>
                    ...
                    <p className='text-white ml-14 text-lg'>Get Detailed Information</p>
                    <button className="px-5 py-3 text-white duration-100 border-2 border-white rounded-full hover:border-indigo-600 hover:bg-blue-900 active:shadow-lg mt-5 text-xl font-bold ml-16">Visit Our Store!</button>
                </div>
            </div>
